    ...
    <form method="POST" action="{{ route('admin.events.store') }}" class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" required placeholder="Ej: Taller de Inducción Institucional"
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3" placeholder="Detalles u observaciones del evento..."
        ...
        <div class="space-y-4 pt-4 border-t border-slate-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="date" id="event_date" name="event_date" value="{{ old('event_date', date('Y-m-d')) }}" required
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 outline-none text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="time" id="end_time" name="end_time" value="{{ old('end_time', '12:00') }}"
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 outline-none text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" id="location" name="location" value="{{ old('location') }}" placeholder="Ej: Salón Multiusos / Virtual"
                       class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 outline-none text-sm">
            </div>
        </div>
